...
class DataLoaderDereferencerBase {
...
class DataLoaderDereferencerClassSubclassFeatures extends DataLoaderDereferencerBase {
 ...
 * @abstract
 */
class DataLoaderDereferencerGenericFeatures extends DataLoaderDereferencerBase {
	_page;
	_tag;
	_prop;
...
class DataLoaderDereferencerOptionalfeatures extends DataLoaderDereferencerGenericFeatures {
...
class DataLoaderDereferencerFeats extends DataLoaderDereferencerGenericFeatures {
	_page = UrlUtil.PG_FEATS;
	_tag = "feat";
	_prop = "feat";
}

class DataLoaderDereferencerItemEntries extends DataLoaderDereferencerBase {
...
class DataLoaderDereferencerFacade {
