...
const PILL_STATE_TO_DISPLAY_CLASS = {
...
const getPillStateDisplayClass = pillState => PILL_STATE_TO_DISPLAY_CLASS[pillState] ?? PILL_STATE_TO_DISPLAY_CLASS[PILL_STATE__IGNORE];

const MISC_FILTER_VALUE__BASIC_RULES_2014 = "Basic Rules (5e/2014)";
const MISC_FILTER_VALUE__BASIC_RULES_2024 = "Basic Rules (5.5e/2024)";
...
/** @abstract */
let PageFilterBase$1 = class PageFilterBase {
...
class FilterSnapshotUiTabUtils {
	static getStgControls () { return ee`<div class="ve-w-100 ve-flex-col"></div>`; }
	static getStgNoRows () { return ee`<div class="ve-h-100 ve-min-h-0 ve-w-100 ve-overflow-y-scroll ve-flex-vh-center"></div>`; }
}
...
class CompSearch extends BaseComponent {
	_getDefaultState () {
		return {
			searchTermParent: "",
		};
...
let SourceFilter$1 = class SourceFilter extends Filter {
	...
	constructor (opts) {
		...
		opts.selFn = opts.selFn === undefined ? PageFilterBase$1.defaultSourceSelFn : opts.selFn;
...
globalThis.PageFilterBase = PageFilterBase$1;
