function d20plusBackgrounds () {
	...
	d20plus.backgrounds.handoutBuilder = d20plus.importer.makeHandoutBuilder(
		d20plus.backgrounds,
		"Backgrounds",
		(data) => UrlUtil.URL_TO_HASH_BUILDER[UrlUtil.PG_BACKGROUNDS](data),
		(data) => d20plus.importer.getTagString([Parser.sourceJsonToFull(data.source)], "background"),
	);

	d20plus.backgrounds.playerImportBuilder = d20plus.importer.makePlayerImportBuilder(d20plus.backgrounds);
