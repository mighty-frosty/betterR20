 ...
 *
 * TODO: Test whether the overlay canvas still renders correctly in Jumpgate.
 * Key things to verify:
 *   - .canvas-container selector still exists inside #editor-wrapper
 *   - d20.engine.setCanvasSize is still a replaceable function
 *   - d20.engine.weathercanvas assignment still works
 *
 * Originally in: js/base/base-weather.js
 */
